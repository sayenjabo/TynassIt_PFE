...
\subsection{Tâches et estimations du sprint~2}

\begin{table}[H]
  \centering
  \caption{Tâches et estimations --- Sprint~2}
  ...
  \begin{tabularx}{\textwidth}{llXcc}
    ...
    \midrule
    \multicolumn{4}{r}{\textbf{Total}} & \textbf{14} \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{itemize}
  ...
  \item \textbf{URLs distinctes}~: \texttt{admin-dashbord-mypfe.vercel.app} et
...
Les 8 user stories couvertes sont toutes en état \textit{done}. Le chapitre suivant
