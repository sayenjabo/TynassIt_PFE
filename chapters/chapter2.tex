% ================================================================
% chapters/chapter2.tex --- RECONSTRUCTION
% ----------------------------------------------------------------
% Assemblé à partir des fragments retrouvés dans le project knowledge
% (recherches successives, plusieurs se recoupant), PAS une copie
% directe d'un fichier source unique. Confiance élevée : chaque
% section a été retrouvée et confirmée, la table du backlog (23 US)
% a été retrouvée en entier en une seule recherche. Recommandation :
% fais un diff rapide contre ton fichier réel avant d'écraser
% l'original, par sécurité.
%
% CE QUI EST CORRIGÉ ICI (déjà appliqué, rien à recoller) :
%   - \subsubsection{Usability (Learnability)} --- le bullet
%     "Interface VR simple" ne prétend plus l'absence de clavier
%     virtuel (contredit par le code ET par ton propre chapitre 5).
%
% RIEN D'AUTRE N'A ÉTÉ MODIFIÉ. Toutes les autres sections (besoins
% fonctionnels/non-fonctionnels, modélisation, architecture, backlog,
% sprints) sont reproduites telles que retrouvées, placeholders
% inclus (diagrammes UML, figures --- toujours à insérer par toi).
% ================================================================
