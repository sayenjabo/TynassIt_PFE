...
mesurer objectivement les résultats. Dans les deux cas, la direction del'entreprise cliente reste sans
...
offrant aux entreprises les moyens de gérer la formation de leurs employés et de suivre objectivement leurs
performances~?
...
trois composantes complémentaires. Un backend qui assure 
l'authentification sécurisée, la gestion des accès et le suivi des sessions de formation.
Deux tableaux de bord web offrant, l'un aux équipes Tynass la gestion
...
une approche inspirée de Agile, itérative et incrémentale~--- ainsi que l'environnement de
...
développement réalisées (une itération par chapitre), chacune apportant de nouvelles fonctionnalités à la plateforme~:
